...
const Banner = ({ data, isLoading }) => {
	...
	const customStyles = {
		...
		input: (provided, state) => ({
			...provided,
			color: state.isFocused ? "#e2e8f0" : "#0d9488",
		}),
	...
	return (
		<div className="Banner flex h-[300px] w-full flex-col items-center justify-center md:h-[350px] lg:h-[400px]">
			<div>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 513 294"
					className="h-[150px] w-[150px] md:h-[180px] md:w-[180px] lg:h-[200px] lg:w-[200px]">
					<path
						fill="#fff"
